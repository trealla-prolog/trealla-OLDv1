...
pl_idx_t g_dcg_s, g_throw_s, g_sys_block_catcher_s, g_sys_drop_call_barrier;
...
prolog *pl_create()
{
	...
	CHECK_SENTINEL(g_sys_drop_call_barrier = index_from_pool(pl, "$drop_call_barrier"), ERR_IDX);
