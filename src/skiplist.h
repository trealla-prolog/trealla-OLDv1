...
extern skiplist *sl_create(int (*compkey)(const void *k1, const void *k2, const void* p), void (*delkey)(void *k, void *v), const void *p);
...
extern void sl_dump(const skiplist *l, const char *(*f)(const void* k, const void *p), void *p);
