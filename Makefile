...
SRCOBJECTS += src/imath/imath.o src/isocline/isocline.o
...
clean:
	rm -f tpl src/*.o src/imath/*.o src/isocline/*.o \
...
src/isocline.o: src/isocline/isocline.c src/isocline/isocline.h
